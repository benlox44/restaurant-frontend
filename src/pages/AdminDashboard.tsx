...
export default function AdminDashboard() {
  ...
  const menuOptions = [
    { title: 'Ver Pedidos', path: '/admin/orders', icon: '📋', description: 'Gestionar todos los pedidos' },
    { title: 'Gestionar Menú', path: '/admin/menu', icon: '🍽️', description: 'Editar ítems del menú' },
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-green-600/20 border border-green-500/30 rounded-xl p-6">
            <h4 className="text-green-300 text-sm font-medium mb-2">Ítems Activos del Menú</h4>
            <p className="text-3xl font-bold text-white">24</p>
          </div>
          <div className="bg-purple-600/20 border border-purple-500/30 rounded-xl p-6">
            <h4 className="text-purple-300 text-sm font-medium mb-2">Ventas de Hoy</h4>
