...
export default function AdminDashboard() {
  ...
  const menuOptions = [
    { title: 'Ver Pedidos', path: '/admin/orders', icon: '📋', description: 'Gestiona todos los pedidos' },
    { title: 'Crear Menú', path: '/admin/menu/create', icon: '➕', description: 'Añade nuevos platillos' },
    { title: 'Editar Menú', path: '/admin/menu/edit', icon: '✏️', description: 'Modifica platillos existentes' },
    { title: 'Eliminar Menú', path: '/admin/menu/delete', icon: '🗑️', description: 'Elimina platillos' },
  ];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-blue-600/20 border border-blue-500/30 rounded-xl p-6">
            <h4 className="text-blue-300 text-sm font-medium mb-2">Pedidos Pendientes</h4>
            <p className="text-3xl font-bold text-white">12</p>
          </div>
          <div className="bg-green-600/20 border border-green-500/30 rounded-xl p-6">
            <h4 className="text-green-300 text-sm font-medium mb-2">Menús Activos</h4>
            <p className="text-3xl font-bold text-white">24</p>
          </div>
          <div className="bg-purple-600/20 border border-purple-500/30 rounded-xl p-6">
            <h4 className="text-purple-300 text-sm font-medium mb-2">Ventas Hoy</h4>
